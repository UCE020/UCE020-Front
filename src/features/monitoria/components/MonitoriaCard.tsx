...
export function MonitoriaCard({ event, onClick }: EventCardProps) {
  return (
    <button
      type="button"
    ...
    >
      {/* Imagem do evento */}
      <div className="relative w-[64px] h-[64px] flex-shrink-0 rounded-2xl overflow-hidden bg-[#f0faf7]">
        <Image
          src={event.foto ?? "/images/certificadoVariacao2.png"}
          alt={event.nome}
          fill
